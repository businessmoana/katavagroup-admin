export const Routes = {
  ...
  priceGroup: {
    ...routesFactory('/data-list/price-group'),
  },
  dateInterval: {
    ...routesFactory('/data-list/date-interval'),
  },
  tax: {
    ...routesFactory('/taxes'),
  },
  ...
  newShops: '/new-shops',
  chefOrders:'/chef/chef-orders',
  chefInvoices:'/chef/chef-invoices',
  sales:'/chef/sales',
  marketStatement:'/chef/market-statement',
  chefsStatement:'/chef/chefs-statement',
  groupChefsStatement:'/chef/group-chefs-statement',
